...
<header>
    ...
    <nav>
        <ul>
            ...
            <a href="index.php" class="nav-link" style="text-decoration: none;color: white;"><li class="nav-link active">VVIP</li></a>
...
<div class="dashboard">
    <aside class="panel">
    <div class="panel-title">Batch Generator ~ Vvip</div>
...
<script>
    ...
    const uniqueID = "vv" + randomNumber; 
