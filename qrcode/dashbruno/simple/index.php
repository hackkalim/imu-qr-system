...
<header>
    ...
    <nav>
        <ul>
            ...
            <a href="index.php" class="nav-link" style="text-decoration: none;color: white;"><li class="nav-link active">Simple</li></a>
...
<div class="dashboard">
    <aside class="panel">
    <div class="panel-title">Batch Generator ~ Simple</div>
...
<script>
    ...
    function processLoop(baseImg) {
        ...
        new QRCode(document.getElementById("qrcode-hidden"), { text: uniqueID.toString(), width: 200, height: 200 });
...
function exportCSV() {
    ...
    a.setAttribute('download', 'qrcode_report.csv');
